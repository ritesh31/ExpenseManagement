...
var jsFilesToInject = [
  ...
  '/js/app-module.js',
  '/js/controller/new-expense-controller.js',
  '/js/controller/list-expense-controller.js',
  '/js/controller/details-expense-controller.js',
  '/js/service/expense-service.js',
  'js/**/*.js'
];
